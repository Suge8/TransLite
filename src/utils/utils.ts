...
export function getReviewUrl(utmSource: string = "extension"): string {
  if (import.meta.env.BROWSER === "edge") {
    return "https://microsoftedge.microsoft.com/addons/detail/translite-open-source-i/cbcbomlgikfbdnoaohcjfledcoklcjbo?form=MA13IW"
  }
  return `https://chromewebstore.google.com/detail/translite-open-source-imm/modkelfkcfjpgbfmnbnllalkiogfofhb/reviews?utm_source=${utmSource}`
}
