...
export function AutoTranslateSites() {
  ...
  return (
    <ConfigCard id="auto-translate-sites" title={i18n.t("options.translation.autoTranslateSites.title")}>
      <PatternsTable
        patterns={autoTranslatePatterns}
        onAddPattern={addPattern}
        onRemovePattern={removePattern}
        placeholderText={i18n.t("options.translation.autoTranslateSites.enterUrlPattern")}
        tableHeaderText={i18n.t("options.translation.autoTranslateSites.urlPattern")}
      />
    </ConfigCard>
  )
}
